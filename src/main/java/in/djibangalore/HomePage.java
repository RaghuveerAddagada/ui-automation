...
public class HomePage {
    ...
    final By DJI_BANGALORE_LEFT_TOP_LOGO = By.xpath("//h3[@id='logo-text-191091']");
    final By HOME_IN_HEADER = By.xpath("//*[@id=\"nav-191092\"]/li[1]/a");
    final By SHOP_IN_HEADER = By.xpath("//*[@id=\"nav-191092\"]/li[2]/a");
    final By REVIEWS_IN_HEADER = By.xpath("//*[@id=\"nav-191092\"]/li[3]/a");
    final By CONTACT_US_IN_HEADER = By.xpath("//*[@id=\"nav-191092\"]/li[4]/a");
    final By INSTAGRAM_IN_HEADER = By.xpath("//*[@id=\"nav-191092\"]/li[5]/a");

    final By PHONE_NUMBER_IN_HOME_PAGE = By.xpath("//*[@id=\"n-191076\"]/div/section/div[2]/div/div[2]/div[2]/div[2]/p/a");
    ...
    public void validateHeaderMenuItems() {
        ...
        Assert.assertEquals(browserActions.getTextFromElement(PHONE_NUMBER_IN_HOME_PAGE), "+91-8095086806", "Contact number has been changed");
